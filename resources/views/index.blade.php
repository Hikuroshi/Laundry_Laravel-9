...
<div class="container pb-5">
    <div class="row align-items-center">
        <div class="col-md-5 col-lg-7 order-md-1 text-end">
            <img class="img-fluid" src="/img/laundry-landing.png" alt="Laundry">
        </div>
        <div class="col-md-7 col-lg-5 text-center text-md-start pt-5 pe-lg-5">
            <h1 class="fw-bold mb-3">Baju Tinggal Pakai, Gak Pake Ribet</h1>
            <p>Jangan biarkan pakaian kotor menumpuk di rumah kamu! Gunakan jasa laundry kami untuk menjaga pakaian kamu tetap bersih dan harum sepanjang waktu.</p>
        </div>
    </div>
</div>
            ...
            <div class="card rounded-5">
                <div class="row m-5 align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6 py-5 py-md-0">
                        ...
                        <p class="card-text">Apakah kamu memiliki seprai atau selimut yang perlu dicuci? Atau mungkin karpet, gorden, atau bantal sofa? Kami dapat membersihkan semuanya untuk kamu! Kami juga dapat mencuci sepatu, jaket kulit, dan tas, serta membersihkan dan merawat jas dan pakaian formal lainnya.</p>        
                    </div>
                </div>
            </div>
        </div>
...
<div class="container py-5">
    <div class="row text-center">
        <h1 class="my-4 fw-bold">Keuntungan dan Kelebihan</h1>
        <p>Tidak ada lagi alasan untuk khawatir tentang mencuci barang rumah tangga kamu. Percayakan kami untuk menangani semuanya dengan cepat, efektif, dan efisien.<br>Banyak lebihnya dan gak sedikit keuntungan yang kamu dapetin!</p>
    </div>
</div>
...
<div class="container py-5">
    <div class="row text-center">
        <h1 class="my-4 fw-bold">Outlet dan Paket</h1>
        <p>Ayo segera datang ke outlet yang terdekat dan cari paket dengan harga terbaik.</p>
    </div>
</div>
            ...
            <div class="card rounded-4 py-5 pe-lg-4 pe-md-0">
                <div class="row g-0">
                    ...
                    <div class="col-md-8 card-body text-center text-md-start">
                        ...
                        <p class="card-text">Banyak paket yang bisa kamu pilih sesuai dengan kebutuhan mu.</p>
                        <a href="/pakets" class="btn btn-primary px-4 rounded-pill fw-bold">Selengkapnya</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card rounded-4 py-5 pe-lg-4 pe-md-0">
                <div class="row g-0">
                    ...
                    <div class="col-md-8 card-body text-center text-md-start">
                        ...
                        <p class="card-text">Outlet yang sudah tersebar luas diberbagai tempat</p>
                        <a href="/outlets" class="btn btn-primary px-4 rounded-pill fw-bold">Selengkapnya</a>
                    </div>
                </div>
            </div>
        </div>
