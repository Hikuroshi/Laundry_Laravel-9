...
<section class="section">
    <div class="card">
        <div class="card-body">
            <form action="/dashboard/outlets" method="post">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <input name="telepon" type="number" id="telepon" class="form-control @error('telepon') is-invalid @enderror" value="{{ old('telepon') }}" placeholder="Masukan nomor telepon outlet...">
                    @error('telepon')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
