        ...
        <div class="card-body">
            <form action="/dashboard/pakets/{{ $paket->slug }}" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <input name="harga" type="number" id="harga" class="form-control @error('harga') is-invalid @enderror" value="{{ old('harga', $paket->harga) }}" placeholder="Masukan nomor harga paket...">
                    @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
